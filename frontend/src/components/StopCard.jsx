  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`absolute -top-3 right-8 bg-white dark:bg-stone-900 shadow-sm border rounded-lg flex items-center overflow-hidden transition-opacity duration-200 opacity-0 group-hover:opacity-100 border-stone-200 dark:border-stone-800`}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="p-1 transition-transform hover:scale-110 z-10" 
                  title="Favorite"
                >
