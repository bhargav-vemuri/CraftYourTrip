  ...
  return (
    <div className="mb-12 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 relative group/day">
      ...
      <div ref={setNodeRef} className="relative min-h-[50px]">
        {day.stops.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-10 px-4 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 text-center">
            <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mb-3">
              <svg className="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
            </div>
            <p className="text-sm font-medium text-gray-600">No activities planned yet.</p>
            <p className="text-xs text-gray-400 mt-1">Drag stops here or click "Add a stop" below.</p>
          </div>
        ) : (
