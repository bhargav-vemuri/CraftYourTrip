...
export default function HeroSection() {
  return (
    <div className="text-center py-20 px-4 sm:px-6 lg:px-8 relative w-full max-w-4xl mx-auto animate-slide-up">
      ...
      {/* Decorative badge */}
      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-100/50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 mb-8 backdrop-blur-sm transition-transform hover:scale-105 duration-300 cursor-default animate-stagger-1">
