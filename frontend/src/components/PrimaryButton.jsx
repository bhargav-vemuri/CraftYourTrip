    ...
    <button
      ...
      className={`relative w-full sm:w-auto px-8 py-4 font-bold rounded-2xl transition-all duration-300 text-lg flex justify-center items-center gap-2 overflow-hidden group ${
        disabled 
          ...
          : 'bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-600 bg-[length:200%_auto] text-white shadow-[0_0_40px_-10px_rgba(16,185,129,0.5)] hover:shadow-[0_0_60px_-15px_rgba(16,185,129,0.7)] hover:-translate-y-0.5 active:translate-y-0 active:scale-95'
      }`}
    >
